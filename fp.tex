...
\subsection{Endofuntori in $\mathcal{JS}$}
...
\begin{verbatim}
const map2 = <A, B, C>(fa: F<A>, fb: F<B>, f: (a: A, b: B) => C): F<C> => ???

const map3 = <A, B, C, D>(fa: F<A>, fb: F<B>, fc: F<C>, f: (a: A, b: B, c: C) => D): F<D> => ???
...
\section{Debugging with \texttt{Trace}}
...
\subsection{Funzioni costellazione}

Anche a \texttt{Foldable} possono essere associate una serie di utili funzioni costellazioni, vediamone alcune
